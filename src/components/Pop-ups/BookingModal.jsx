      ...
      >
        <div className="size-full mx-auto flex justify-center items-center">
          <div className="p-8 md:max-w-7xl w-full h-full flex flex-col">
            <PlatosSeleccion
              asistentes={detalleAsistentes.asistentes}
              firestoreId={"5554545"}
    ...
    >
      <div className="w-full h-full max-w-5xl mx-auto px-2 md:px-4 flex items-center justify-center">
        <div className="w-full lg:h-[40.2060625rem] h-full flex lg:flex-row flex-col items-stretch bg-white/20 rounded-xl lg:gap-6 gap-3 lg:p-6 p-3 md:py-4 overflow-hidden">
          <div className="lg:w-1/3 w-full lg:h-full h-auto flex flex-col justify-start lg:justify-between overflow-y-auto lg:overflow-y-visible max-lg:gap-2 lg:py-8">
            <h2 className="lg:pl-4 font-danson lg:mb-8 mb-4 flex-shrink-0 lg:text-start text-center">
              <span className="lg:!text-2xl !text-3xl">Realiza tu</span>{" "}
              <br className="max-lg:hidden" />
              <span className="lg:!text-7xl lg:leading-7 !text-5xl">
                reserva
              </span>
            </h2>
          ...
          <div className="flex-1 lg:h-full h-auto bg-[#faf7f1] text-dark rounded-lg overflow-hidden min-h-0">
            <SliderVertical />
          </div>
        </div>
      </div>
